...
try {
  ...
  files.push(`${DIR}/migrations/001_hr30_pilot_aw3.sql`, `${DIR}/migrations/002_nip_sequence.sql`, `${DIR}/migrations/003_user_permissions.sql`, `${DIR}/migrations/004_modul_lanjutan.sql`, `${DIR}/migrations/005_koreksi_presensi.sql`, `${DIR}/migrations/006_gateway_undangan.sql`);
